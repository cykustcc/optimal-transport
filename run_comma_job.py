...
def run(INTERVAL):
	if _platform == "linux" or _platform == "linux2" or _platform=="linux3":
		synthesizecloud_root="/home/yzc147/Projects/optimal-transport/comma1/";
		synthesizecloudflow_root="/home/yzc147/Projects/optimal-transport/comma1_momentumflow/";
		synthesizecloudflow_mislaneous_root="/home/yzc147/Projects/optimal-transport/comma1_momentumflow_mislaneous/";
		color_flow="/home/yzc147/Projects/epic_flow/flow-code/color_flow";
	elif _platform == "darwin":
		synthesizecloud_root="/Users/MAC/Documents/Code/explore/optimal-transport/comma1/";
		synthesizecloudflow_root="/Users/MAC/Documents/Code/explore/optimal-transport/comma1_momentumflow/";
		synthesizecloudflow_mislaneous_root="/Users/MAC/Documents/Code/explore/optimal-transport/comma1_momentumflow_mislaneous/";
	...
	for i in xrange(int(len(img_file_list))/INTERVAL-1):#,len(img_file_list)-1):
		...
		flowcolorfile=flw_fld+basename+"_flow.png";flowcolorfile=re.sub(" ","\ ",flowcolorfile);
